      ...
      >
        <form onSubmit={handleCommentSubmit}>
          ...
          <div className="flex justify-end mt-2">
            <button 
              type="submit" 
              className="px-4 py-2 rounded-lg transform hover:scale-105 active:scale-95 hover:brightness-90 cursor-pointer"
              style={{ 
        ...
        <div key={comment.id} className="mb-6">
          <div className="flex items-start mb-2">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1" style={{ color: theme.core.text }}>{comment.text}</p>
              
              <div className="flex mt-2 items-center">
                <button 
                  onClick={() => handleLike(comment.id)}
                  className="flex items-center mr-4 cursor-pointer transform hover:scale-110 active:scale-95"
                  style={{ 
                ...
                <div className="relative">
                  <button 
                    ...
                    className="p-1 rounded-full cursor-pointer hover:bg-opacity-20 transform hover:scale-110 active:scale-95"
                    style={{ 
                      color: theme.core.text + '80',
                      transition: 'transform 0.1s ease' 
                    }}
                  >
                  ...
                  {openDropdownId === comment.id && (
                    <div 
                      ref={dropdownRef}
                      className="absolute right-0 mt-2 w-48 rounded-md shadow-lg z-10 overflow-hidden"
                      style={{ backgroundColor: theme.core.background }}
                    >
                      <div className="py-1">
                        <button
                          onClick={() => handleDeleteComment(comment.id)}
                          className="w-full text-left px-4 py-2 text-sm flex items-center hover:brightness-90 hover:bg-gray-400 active:brightness-75 transform hover:translate-x-1 active:translate-x-0"
                          style={{ 
                            color: theme.core.text,
                            transition: 'transform 0.1s ease'
                          }}
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ transition: 'none' }}>
