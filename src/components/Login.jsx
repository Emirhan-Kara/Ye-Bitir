...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-300 to-gray-400 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/signup" className="font-medium text-red-800 hover:text-red-700">
                Sign up
              </Link>
            </p>
          </div>
