...
const RecipeCard = ({ 
  ...
  return (
    <div className="w-72 m-2 bg-[#e2ece0] rounded-xl overflow-hidden shadow-md transition-transform duration-300 hover:shadow-lg hover:scale-105 cursor-pointer">
      ...
      <div className="p-4">
        ...
        <h3 className="text-lg font-semibold text-[#34495e] mb-2 h-14 line-clamp-2 overflow-hidden">{title}</h3>
