...
const RecipeCard = ({ 
  ...
  return (
    <div className="w-72 bg-red-700 rounded-xl overflow-hidden shadow-md transition-transform duration-300 hover:shadow-lg hover:scale-105 cursor-pointer">
      ...
      <div className="p-4">
        ...
        <div className="flex flex-col space-y-1 text-sm text-white">
          ...
          <div className="grid grid-cols-3 gap-2">
            {/* Cooking Time */}
            <div className="flex flex-col items-center justify-center bg-red-800 p-2 rounded">
