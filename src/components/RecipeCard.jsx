...
const RecipeCard = ({ 
    ...
    image = "https://media.istockphoto.com/id/1469228227/photo/fresh-salad-of-lentils-spinach-and-almonds.jpg?s=612x612&w=0&k=20&c=BALCedb7wuJHe3uQ5uokTnsqgZ97L3WNHNaN71zT1K8=",
    timeInMins = 30,
    rating = 4.8,
    servings = 2
}) => {
  return (
    <div className="w-72 m-2 bg-red-900 rounded-xl overflow-hidden shadow-md transition-transform duration-300 hover:shadow-lg hover:scale-105 cursor-pointer">
      ...
      <div className="p-4">
        ...
        <h3 className="text-lg font-semibold text-white mb-2 h-14 line-clamp-2 overflow-hidden">{title}</h3>
        ...
        <div className="flex flex-col space-y-1 text-sm text-white">
          ...
          <div className="grid grid-cols-3 gap-2">
            {/* Cooking Time */}
            <div className="flex flex-col items-center justify-center bg-yellow-600 p-1 pb-2 rounded">
