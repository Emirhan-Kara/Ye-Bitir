...
import { Home, UtensilsCrossed, Users, BarChart2, Settings, LogOut, Search, Filter, Eye, Lock, Unlock } from 'lucide-react';
      ...
      <div className="flex flex-1">
        <aside className="w-64" style={{ backgroundColor: themeColors.secondary }}>
          ...
          <nav className="mt-6">
            ...
            <Link to="/admin/users" className="flex items-center px-6 py-4 text-white" style={{ backgroundColor: themeColors.primary }}>
        ...
        <main className="flex-1 p-8" style={{ backgroundColor: themeColors.background }}>
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-2xl font-bold" style={{ color: themeColors.text.primary }}>User Management</h1>
              <p style={{ color: themeColors.text.secondary }}>Manage users and monitor their activities</p>
            </div>
